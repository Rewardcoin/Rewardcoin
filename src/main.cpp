...
uint256 hashGenesisBlock("0x158390e616bd0c73959d922dcba17bdf84deda322b0ee6a7bf0a796c8305449b");
static const unsigned int timeGenesisBlock = 1441972800;// changedxx
...
const string strMessageMagic = "Rewardcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "https://bitcointalk.org/index.php?topic=1175701.0";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1441972800;//timeGenesisBlock;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 119201945;
        block.nBirthdayA = 221585;
        block.nBirthdayB = 4129959;
       


        if (fTestNet)
        {
            block.nTime    = 1441972800;
            block.nNonce   = 119201945;
        }
        ...
        block.print();
        static const uint256 hashGenesisMerkleRoot = uint256("0x3c17a1cccb4ee903c6a95341b21727f5b38f8f8266171ab5d769d186ce10f37c");
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RewardcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RewardcoinMiner : ProcessBlock, block not accepted");
    }
