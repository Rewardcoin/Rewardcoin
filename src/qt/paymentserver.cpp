...
const QString BITCOIN_IPC_PREFIX("Rewardcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Rewardcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Rewardcoin: click-to-pay handler");
    else
...
{
    // clicking on Rewardcoin: URLs creates FileOpen events on the Mac:
